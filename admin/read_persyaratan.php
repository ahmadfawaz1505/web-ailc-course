...
$ambil=$_GET['id'];
$data = mysqli_query($conn, "SELECT * FROM persyaratan where id_persyaratan = '$ambil' ");
  ...
  <div class="content">
    ...
    <div class="kiri">
      ...
      if (isset($_POST['simpan'])) {
        $query=mysqli_query($conn, "UPDATE persyaratan SET judul= '".$_POST['judul']."',
                                                    isi  = '".$_POST['isi']."'
                                                    WHERE id_persyaratan = '$ambil' ");
